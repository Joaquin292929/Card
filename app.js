...
const productos = [
    { id: 1, imagen: "placabase.jpg", titulo: "Placa Base", descripcion: "Placa base ATX.", precio: "150.00€" },
    { id: 2, imagen: "teclado.jpg", titulo: "Teclado", descripcion: "Teclado 100%.", precio: "50.00€" },
    { id: 3, imagen: "disco.jpg", titulo: "SSD M.2", descripcion: "Dos SSD M.2.", precio: "380.00€" }
];
...
productos.forEach(producto => {
    ...
    cartButton.addEventListener("click", () => {
        ...
        if (cartItem) {
            cartItem.cantidad++;
            alert(`Cantidad de ${producto.titulo} actualizada a ${cartItem.cantidad}.`);
        } else {
